...
- [AccountNftGetInfo.proto](#AccountNftGetInfo.proto)
  - [GetAccountNftInfoQuery](#GetAccountNftInfoQuery)
  - [GetAccountNftInfoResponse](#GetAccountNftInfoResponse)
  - [NftOwnedInfo](#NftOwnedInfo)

- [BasicTypes.proto](#BasicTypes.proto)
  - [AccountAmount](#AccountAmount)
  - [AccountID](#AccountID)
  - [AmountOrSerialNumbers](#AmountOrSerialNumbers)
...
- [NftGetInfo.proto](#NftGetInfo.proto)
  - [GetNftInfoQuery](#GetNftInfoQuery)
  - [GetNftInfoResponse](#GetNftInfoResponse)
  - [NftInfo](#NftInfo)
...
- [TokenMint.proto](#TokenMint.proto)
  - [AmountOrMemo](#AmountOrMemo)
  - [TokenMintTransactionBody](#TokenMintTransactionBody)

- [TokenNftGetInfo.proto](#TokenNftGetInfo.proto)
  - [GetTokenNftInfoQuery](#GetTokenNftInfoQuery)
  - [GetTokenNftInfoResponse](#GetTokenNftInfoResponse)
...
| start |  | Specifies the start (including) of the range of NFTs to query for. Value must be in the range (0; ownedNFTs] | |
| end |  | Specifies the end (including) of the range of NFTs to query for. Value must be in the range [start; ownedNFTs] | |


<a name="GetAccountNftInfoResponse"></a>

### GetAccountNftInfoResponse
...
| nfts | [NftOwnedInfo](#NftOwnedInfo) | List of NFTs associated to the account | |


<a name="NftOwnedInfo"></a>
...
| memo |  | Represents the unique metadata for a given NFT instance | |
...
<a name="AmountOrSerialNumbers"></a>
...
| Field | Type | Description |   |
| ----- | ---- | ----------- | - |
| amountOrSerialNumbers | oneof |  | |
| | amount |  | Applicable to tokens of type FUNGIBLE. Amount of fungible tokens to burn/wipe | |
| | serialNumbers | [SerialNumbers](#SerialNumbers) | Applicable to tokens of type NON_FUNGIBLE. The list of serial numbers to be burned/wiped. | |
...
| Field | Type | Description |   |
| ----- | ---- | ----------- | - |
| fromAccount | [AccountID](#AccountID) | Sending account | |
| toAccount | [AccountID](#AccountID) | Receiving account | |
| serialNo |  | Serial number that is being transferred | |
...
| balance |  | For token of type FUNGIBLE - the balance that the Account holds in the smallest denomination. For token of type NON_FUNGIBLE - the number of NFTs held by the account | |
...
| decimals |  | The number of decimal places a token is divisible by. Always 0 for tokens of type NON_FUNGIBLE | |
...
| transfers | [AccountAmount](#AccountAmount) | Applicable to tokens of type FUNGIBLE. Multiple list of AccountAmounts, each of which has an account and amount | |
| nftTransfers | [NftTransfer](#NftTransfer) | Applicable to tokens of type NON_FUNGIBLE | |
...
| ownedNFTs |  | The number of NFTs that are owned by this account | |
...
| serialNumber |  | The serial number for the NFT for which information is requested | |


<a name="GetNftInfoResponse"></a>
...
| nft | [NftInfo](#NftInfo) | The NFT that his record is for | |
...
| ----- | ---- | ----------- | - |
| serialNumber |  | the serial number of the NFT | |
| owner | [AccountID](#AccountID) | The current owner of the NFT | |
| creationTime | [Timestamp](#Timestamp) | The effective consensus timestamp at which the NFT was minted | |
| memo |  | Represents the unique metadata for a given NFT instance | |
...
| tokens | [TokenID](#TokenID) | The tokens to be associated with the provided account. In the case of NON_FUNGIBLE Type, once an account is associated, it can hold any number of NFTs (serial numbers) of that token type. | |
...
| amountOrSerialNumbers | [AmountOrSerialNumbers](#AmountOrSerialNumbers) | Defines the amount or list of serial numbers to be burned | |
...
| Field | Type | Description |   |
| ----- | ---- | ----------- | - |
| tokenType | [TokenType](#TokenType) | IWA compatibility. Specifies fungible or not | |
...
| decimals |  | For tokens of type FUNGIBLE - the number of decimal places a token is divisible by. For tokens of type NON_FUNGIBLE - value must be 0. | |
| maxSupply |  | IWA Compatibility. For tokens of type FUNGIBLE - the maximum number of tokens that can be in circulation. For tokens of type NON_FUNGIBLE - the maximum number of NFTs (serial numbers) that can be minted. This field can never be changed! | |
| initialSupply |  | Specifies the initial supply of tokens to be put in circulation. The initial supply is sent to the Treasury Account. The supply is in the lowest denomination possible. In the case for NON_FUNGIBLE Type the value must be 0 | |
| treasury | [AccountID](#AccountID) | The account which will act as a treasury for the token. This account will receive the specified initial supply or the newly minted NFTs in the case for NON_FUNGIBLE Type | |
...
| decimals |  | The number of decimal places a token is divisible by. Always 0 for tokens of type NON_FUNGIBLE. This field can never be changed! | |
| maxSupply |  | For tokens of type FUNGIBLE - The Maximum number of fungible tokens that can be in circulation. For tokens of type NON_FUNGIBLE - the maximum number of NFTs (serial numbers) that can be in circulation. This field can never be changed! | |
| totalSupply |  | For tokens of type FUNGIBLE - the total supply of tokens that are currently in circulation. For tokens of type NON_FUNGIBLE - the number of NFTs created of this token instance | |
...
| ----- | ---- | ----------- | - |
|  | oneof |  | |
| | amount |  | Applicable to tokens of type FUNGIBLE. The amount to mint to the Treasury Account. Amount must be a positive non-zero number represented in the lowest denomination of the token. The new supply must be lower than 2^63 | |
| | memo |  | Applicable to tokens of type NON_FUNGIBLE. The metadata for the given NFT instance that is being created | |
...
| amountOrMemo | [AmountOrMemo](#AmountOrMemo) |  | |


<a name="TokenNftGetInfo.proto"></a>
<p align="right"><a href="#top">Top</a></p>

## TokenNftGetInfo.proto
...
| header | [QueryHeader](#QueryHeader) | Standard info sent from client to node, including the signed payment, and what kind of response is requested (cost, state proof, both, or neither). | |
| tokenId | [TokenID](#TokenID) | The ID of the token for which information is requested | |
| start |  | Specifies the start (including) of the range of NFTs to query for. Value must be in the range (0; totalSupply] | |
| end |  | Specifies the end (including) of the range of NFTs to query for. Value must be in the range [start; totalSupply] | |


<a name="GetTokenNftInfoResponse"></a>
...
| header | [ResponseHeader](#ResponseHeader) | Standard response from node to client, including the requested fields: cost, or state proof, or both, or neither | |
| tokenId | [TokenID](#TokenID) | The Token with type NON_FUNGIBLE that this record is for | |
| nfts | [NftInfo](#NftInfo) | List of NFTs associated to the specified token | |
...
| getNftInfo  | Query | Response |  gets info on a NFT by TokenID (of type NON_FUNGIBLE) and serial number |
| getTokenNftInfo  | Query | Response |  Gets info on NFTs N through M on the list of NFTs associated with a given Token of type NON_FUNGIBLE |
...
| amountOrSerialNumbers | [AmountOrSerialNumbers](#AmountOrSerialNumbers) | Defines the amount or list of serial numbers to be wiped | |
...
| serialNumber |  |  In the receipt of a TokenMintTransactionBody, the serial number of the newly created NFT | |
